...
try:
    ...
    from features.courses.models import ClassSchedule, Course, Curriculum, CurriculumCourse, Prerequisite
    ...
    from src.features.courses.models import ClassSchedule, Course, Curriculum, CurriculumCourse, Prerequisite
